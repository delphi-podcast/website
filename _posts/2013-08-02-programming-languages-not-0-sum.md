---
id: 1190
title: 'Sum(Programming Languages) > 0'
date: '2013-08-02T12:32:43-06:00'
author: 'Jim McKeeth'
layout: post
guid: 'http://delphi.org/?p=1190'
permalink: /2013/08/programming-languages-not-0-sum/
tags:
    - Commentary
---

A <a href="https://en.wikipedia.org/wiki/Zero-sum_game">Zero-sum game</a> is a situation where for one contestant to win or gain, the other contestants must lose or have a loss. Thus for contestant A to have a +5 then contestant B must have a -5, resulting in a sum of 0.
...
<a href="http://www.embarcadero.com/">Embarcadero</a> offers a lot of great tools for many different languages, including <a href="http://www.embarcadero.com/products/delphi">Delphi</a>, <a href="http://www.embarcadero.com/products/cbuilder">C++Builder</a> and <a href="http://www.embarcadero.com/products/HTML5-Builder">HTML5 Builder</a> (PHP &amp; JavaScript). Pick the one you like best, or learn something new. You can even grab RAD Studio and get all those tools for one price (and a <a href="http://www.embarcadero.com/radoffer">special promotion</a>!) Then lets celebrate your victories together!
